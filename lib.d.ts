...
export interface HtmlContainerProps extends CommonAttributes, Events, HTMLAttributes {
    children: Array<RecursiveElement>;
}

export interface FragmentProps extends CommonAttributes, Events, HTMLAttributes {
    children: Array<RecursiveElement>;
}
...
export interface LazyColumnProps extends CommonAttributes, Events, HTMLAttributes {
    onObserved: Function;
    children: Array<RecursiveElement>;
}
